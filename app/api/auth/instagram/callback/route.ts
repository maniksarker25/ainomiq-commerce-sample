...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log(
      "[ig-callback] Exchanging code, redirectUri:",
      redirectUri,
      "appId:",
      appId,
      "secretLen:",
    ...
    console.log(
      "[ig-callback] Got long-lived token, expires_in:",
    ...
    await upsertIntegration(
      ...
      "instagram",
      accessToken,
      shortLivedToken, // keep short-lived as backup
      expiresAt,
      scopes,
      igAccountId, // Instagram user ID
      igAccountName,
    );
    console.log(
